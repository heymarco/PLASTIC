...
import moa.classifiers.trees.PLASTIC;
 ...
 * @version 1.1
 */
public class BackgroundLearnerClassifier extends AbstractClassifier implements MultiClassClassifier,
                                                                                  CapabilitiesHandler {
...
//        this.newclassifier.resetLearning();
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
        if (this.getClass() == BackgroundLearnerClassifier.class)
