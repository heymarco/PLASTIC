 ...
 * @version $Revision: 7 $
 */
public class EagerHoeffdingAdaptiveTree extends EagerHoeffdingTree {
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(EagerHoeffdingAdaptiveTree ht);

        public void learnFromInstance(Instance inst, EagerHoeffdingAdaptiveTree ht, SplitNode parent, int parentBranch);
   ...
   @Override
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
        if (this.getClass() == EagerHoeffdingAdaptiveTree.class)
