 ...
 * @version $Revision: 7 $
 */
public class EvaluatePrequentialRecordTreeRevision extends ClassificationMainTask implements CapabilitiesHandler {
    ...
    private List<Long> treeRevisionIndices = new LinkedList();
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        while (stream.hasMoreInstances()
            ...
            if (instancesProcessed % this.sampleFrequencyOption.getValue() == 0
                ...
                if (learner instanceof PerformsTreeRevision) {
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
        if (this.getClass() == EvaluatePrequentialRecordTreeRevision.class)
            return new ImmutableCapabilities(Capability.VIEW_STANDARD, Capability.VIEW_LITE);
        else
            return new ImmutableCapabilities(Capability.VIEW_STANDARD);
    }

    public List<Long> getTreeRevisions() {
        return treeRevisionIndices;
    }
}
